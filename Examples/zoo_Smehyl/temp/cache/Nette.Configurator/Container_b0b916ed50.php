<?php
// source: D:\studenti\IT3\Smehyl\Nette\zoo\app/config/config.neon 
// source: D:\studenti\IT3\Smehyl\Nette\zoo\app/config/config.local.neon 

class Container_b0b916ed50 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\ZooPresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'application.5' => 'App\Presenters\ZooPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\studenti\IT3\Smehyl\Nette\zoo\app',
			'wwwDir' => 'D:\studenti\IT3\Smehyl\Nette\zoo\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'D:\studenti\IT3\Smehyl\Nette\zoo\app/../temp',
		];
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('2'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	/**
	 * @return App\Presenters\ZooPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\ZooPresenter($this->getService('2'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__presenterFactory()
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'D:\studenti\IT3\Smehyl\Nette\zoo\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\studenti\IT3\Smehyl\Nette\zoo\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\studenti\IT3\Smehyl\Nette\zoo\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=zoo', 'root', '', ['lazy' => true]);
	...
	{
		return new Container_b0b916ed50_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	/**
	 * @return App\Model\AkceManager
	 */
	public function createService2()
	{
		$service = new App\Model\AkceManager($this->getService('database.default.context'));
		return $service;
	}
...
class Container_b0b916ed50_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_b0b916ed50 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\studenti\IT3\Smehyl\Nette\zoo\app/../temp/cache/latte');
