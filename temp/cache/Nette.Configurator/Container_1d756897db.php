<?php
// source: C:\Users\maturita\Desktop\nette-project\app/config/config.neon 
// source: C:\Users\maturita\Desktop\nette-project\app/config/config.local.neon 

class Container_1d756897db extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Users\maturita\Desktop\nette-project\app',
			'wwwDir' => 'C:\Users\maturita\Desktop\nette-project\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\Users\maturita\Desktop\nette-project\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\maturita\Desktop\nette-project\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\maturita\Desktop\nette-project\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\maturita\Desktop\nette-project\app/../temp/cache',
	...
	{
		return new Container_1d756897db_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_1d756897db_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_1d756897db $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\Users\maturita\Desktop\nette-project\app/../temp/cache/latte');
