<?php
// source: C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app\presenters/templates/Nabidka/default.latte

use Latte\Runtime as LR;

class Template33006c63e9 extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
        <tr>
			...
			echo LR\Filters::escapeHtmlText(($this->filters->upper)($zajezd->destinace)) /* line 17 */ ?></a></td>
        <td class="text-center"><?php echo LR\Filters::escapeHtmlText(($this->filters->date)($zajezd->datum, 'j. n. Y')) /* line 18 */ ?></td>
