<?php
// source: D:\studenti\IT3\Smehyl\Nette\ck-zadani\app/config/config.neon 
// source: D:\studenti\IT3\Smehyl\Nette\ck-zadani\app/config/config.local.neon 

class Container_e16c6f7d03 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\NabidkaManager' => [1 => ['27_App_Model_NabidkaManager']],
		...
		'services' => [
			...
			'27_App_Model_NabidkaManager' => 'App\Model\NabidkaManager',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\studenti\IT3\Smehyl\Nette\ck-zadani\app',
			'wwwDir' => 'D:\studenti\IT3\Smehyl\Nette\ck-zadani\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'D:\studenti\IT3\Smehyl\Nette\ck-zadani\app/../temp',
		];
	}
	...
	/**
	 * @return App\Model\NabidkaManager
	 */
	public function createService__27_App_Model_NabidkaManager()
	{
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('27_App_Model_NabidkaManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\Presenters\NabidkaPresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\Presenters\NabidkaPresenter($this->getService('27_App_Model_NabidkaManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\studenti\IT3\Smehyl\Nette\ck-zadani\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\studenti\IT3\Smehyl\Nette\ck-zadani\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\studenti\IT3\Smehyl\Nette\ck-zadani\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=cestovka', 'root',
			'', ['lazy' => TRUE]);
	...
	{
		return new Container_e16c6f7d03_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_e16c6f7d03_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e16c6f7d03 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\studenti\IT3\Smehyl\Nette\ck-zadani\app/../temp/cache/latte');
