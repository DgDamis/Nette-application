<?php
// source: C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app/config/config.neon 
// source: C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app/config/config.local.neon 

class Container_7e675769cd extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\NabidkaManager' => [1 => ['2']],
			'App\Forms\FormFactory' => [1 => ['3']],
			'App\Forms\SignInFormFactory' => [1 => ['4']],
			'App\Forms\SignUpFormFactory' => [1 => ['5']],
			...
			'App\Presenters\NabidkaPresenter' => [1 => ['application.4']],
		...
		'services' => [
			...
			'application.4' => 'App\Presenters\NabidkaPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app',
			'wwwDir' => 'C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app/../temp',
		];
	}
	...
	public function createServiceApplication__4(): App\Presenters\NabidkaPresenter
	{
		$service = new App\Presenters\NabidkaPresenter($this->getService('2'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__5(): App\Presenters\SignPresenter
	{
		...
		$service->signUpFactory = $this->getService('5');
		$service->signInFactory = $this->getService('4');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	public function createServiceCache__storage(): Nette\Caching\IStorage
	{
		$service = new Nette\Caching\Storages\FileStorage(
			'C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=nette', 'root', '', ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_7e675769cd $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\Adam\Disk Google\ŠKOLA\PCV\Nette\Nette-application\Examples\ck-zadani\app/../temp/cache/latte');
	...
	public function createService2(): App\Model\NabidkaManager
	{
		$service = new App\Model\NabidkaManager($this->getService('database.default.context'));
		return $service;
	}


	public function createService3(): App\Forms\FormFactory
	{
	...
	public function createService4(): App\Forms\SignInFormFactory
	{
		$service = new App\Forms\SignInFormFactory($this->getService('3'), $this->getService('security.user'));
		return $service;
	}


	public function createService5(): App\Forms\SignUpFormFactory
	{
		$service = new App\Forms\SignUpFormFactory($this->getService('3'), $this->getService('1'));
		return $service;
	}
