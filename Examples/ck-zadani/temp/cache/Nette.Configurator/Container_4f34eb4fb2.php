<?php
// source: D:\www\ck-zadani\app/config/config.neon 
// source: D:\www\ck-zadani\app/config/config.local.neon 

class Container_4f34eb4fb2 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\www\ck-zadani\app',
			'wwwDir' => 'D:\www\ck-zadani\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'D:\www\ck-zadani\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\www\ck-zadani\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\www\ck-zadani\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\www\ck-zadani\app/../temp/cache',
	...
	{
		return new Container_4f34eb4fb2_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_4f34eb4fb2_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_4f34eb4fb2 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\www\ck-zadani\app/../temp/cache/latte');
