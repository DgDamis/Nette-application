...
class NewsManager
{
	...
	const
		TABLE_NAME = 'news',
		COLUMN_ID = 'id',
		COLUMN_ID_PRODUCT = 'id_product',
		COLUMN_TITLE = 'title',
		COLUMN_PUBLISHED_BY = 'published_by',
	...
	{
            return $this->database->table(self::TABLE_NAME)->order(self::COLUMN_PUBLISHED_AT.' DESC')->limit($limit, $offset)->fetchAll();
	}
